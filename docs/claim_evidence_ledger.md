...
| The new comparison is fair and preregistered | B0--B8 registry, conservative paired-pilot planner, outcome-independent hashed execution schedule, complete paired-matrix validator, exact primary test, and Holm secondary family | software/protocol verification | the design/analysis software is frozen; no real pilot plan or sealed result exists |
