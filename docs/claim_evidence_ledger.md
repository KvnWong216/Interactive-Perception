...
| The new comparison is fair and preregistered | B0--B8 registry, pre-outcome content-addressed initial-state cohort, conservative paired-pilot planner, outcome-independent hashed execution schedule, complete paired-matrix validator, exact primary test, and Holm secondary family | software/protocol verification | the design/analysis software is frozen; no real cohort, pilot plan, or sealed result exists |
