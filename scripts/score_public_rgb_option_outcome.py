...
def main() -> None:
    ...
    parser.add_argument(
        "--fusion",
        choices=("v12b", "v13-complementary"),
        default="v12b",
        help="camera composition; v13 is a development candidate",
    )
    ...
    critic_cls = (
        V13ComplementaryPublicRGBOutcomeCritic
        if args.fusion == "v13-complementary"
        else V12bPublicRGBOutcomeCritic
    )
    critic = critic_cls(args.composite, root=ROOT)
